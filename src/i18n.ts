...
const translations: Record<Locale, Record<TranslationKey, string>> = {
  ...
  de: {
    ...
    checkoutUnavailable: "Checkout ist voruebergehend nicht verfuegbar. Bitte versuchen Sie es erneut.",
  ...
  es: {
    ...
    checkoutUnavailable: "El checkout no esta disponible temporalmente. Intentalo de nuevo.",
  ...
  fr: {
    ...
    checkoutUnavailable: "Le checkout est temporairement indisponible. Veuillez reessayer.",
  ...
  it: {
    ...
    checkoutUnavailable: "Checkout temporaneamente non disponibile. Riprova.",
